...
export default function TrackOrderClient() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFCF7] text-slate-800 flex flex-col font-sans">
      ...
      {/* Hero Header */}
      <section className="bg-gradient-to-b from-[#1F3A2E] to-[#15271F] text-white pt-12 pb-16 px-4 sm:px-6 relative overflow-hidden">
        <div className="max-w-4xl mx-auto text-center space-y-3 relative z-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-[#D4A373] text-xs font-bold uppercase tracking-wider backdrop-blur-xs border border-white/10">
